                ...
                <div class="text-center">
                  ...
                  <n-form ref="stepRef" label-placement="left" label-width="80" label-align="left" require-mark-placement="right" :model="form" :rules="rules">
                    ...
                    <n-form-item label="帳號" path="addAccount.accounts">
                      <n-input v-model:value="form.addAccount.accounts" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="姓名" path="addAccount.name">
                      <n-input v-model:value="form.addAccount.name" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="電子信箱" path="addAccount.mail">
                      ...
                      <n-auto-complete v-model:value="form.addAccount.mail" :input-props="{ autocomplete: 'disabled' }" :options="options">
                    ...
                    <n-form-item label="密碼" path="addAccount.password">
                      <n-input v-model:value="form.addAccount.password" type="password" show-password-on="click" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="密碼" path="addAccount.confirmPwd">
                      <n-input v-model:value="form.addAccount.confirmPwd" type="password" show-password-on="click" placeholder="請輸入內容" clearable />
                    </n-form-item>

                    <p class="pt-5 text-left text-base font-bold">企業資訊</p>
                    <n-form-item label="公司名稱" path="addAccount.companyName">
                      <n-input v-model:value="form.addAccount.companyName" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="統一編號" path="addAccount.taxNumber">
                      <n-input v-model:value="form.addAccount.taxNumber" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="公司地址" path="addAccount.address">
                      <n-input v-model:value="form.addAccount.address" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="公司電話" path="addAccount.phone">
                      <n-input v-model:value="form.addAccount.phone" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="公司傳真" path="addAccount.fax">
                      <n-input v-model:value="form.addAccount.fax" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                    <n-form-item label="公司官網" path="addAccount.website">
                      <n-input v-model:value="form.addAccount.website" type="textarea" :autosize="{ maxRows: 1 }" placeholder="請輸入內容" clearable />
                    </n-form-item>
                  </n-form>
                </div>
                <!--按鈕-->
...
export default defineComponent({
  ...
  computed: {
    options() {
      if (!this.form.addAccount.mail) return [];
      if (this.form.addAccount.mail.indexOf("@") > -1) return [];
      return [
        this.form.addAccount.mail + "@yahoo.com",
        this.form.addAccount.mail + "@yahoo.com.tw",
        this.form.addAccount.mail + "@gmail.com",
        this.form.addAccount.mail + "@msn.com",
        this.form.addAccount.mail + "@hotmail.com",
      ];
    },
  },
  setup() {
